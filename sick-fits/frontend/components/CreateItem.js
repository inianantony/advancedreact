...
export default class CreateItem extends Component {
    ...
    uploadFile = async (e) => {
        ...
        const res= await fetch('https://api.cloudinary.com/v1_1/volunteerwhere/image/upload',{
            method: 'POST',
            body: data
        });
            ...
            {(createItem, { loading, error }) => (
                <Form onSubmit={async (e) => {
                    ...
                    <label htmlFor="file">
                            ...
                            {this.state.image && <img width="100px" src={this.state.image} alt="Upload Preview"/>}
                        </label>
                        <label htmlFor="title">
                            Title
                        ...
                        <label htmlFor="description">
                            Description
                            <textarea type="description" id="description" name="description" placeholder="Enter a Description" required value={this.state.description} onChange={this.handleChange} />
                        </label>
